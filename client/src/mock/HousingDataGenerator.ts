...
export const generateMockData2 = (plz: string, name: string): PropertyData => {
...
export const fetchDataFromApi = async (url: string, params: Record<string, string | number>) => {
...
export const generateMockData = async (plz: string, name: string): Promise<PropertyData> => {
  // Generate base rent and buy prices
